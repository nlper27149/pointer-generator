...
# Where to find data
tf.app.flags.DEFINE_string('data_path', './train_098.bin', 'Path expression to tf.Example datafiles. Can include wildcards to access multiple datafiles.')
...
def run_eval(model, batcher, vocab):
  ...
  while True:
    ...
    ori0 = batch.original_articles[0]
    ori1 = batch.original_articles[1]
